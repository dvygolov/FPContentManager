...
function buildLandingHtml({ appName, displayName = appName, build, bookmarklet, manifestUrl, screenshotUrl, iconUrl }) {
  ...
  return [
    ...
    "          <p class=\"lead\">FPContentManager is a browser-side tool for exporting Facebook Page posts, photos, and videos to JSON, importing text posts from a saved package, and cleaning Page content after a destructive confirmation prompt.</p>",
    "          <div class=\"install\">",
    ...
    "      <div class=\"card\"><strong>Export content</strong><p>Saves Page posts, uploaded photos, and videos into a readable JSON package.</p></div>",
    "      <div class=\"card\"><strong>Import JSON</strong><p>Loads a saved package and imports all text posts to the selected Page in one step.</p></div>",
    "      <div class=\"card\"><strong>Clean content</strong><p>Runs from a red destructive action and asks for browser confirmation before deleting Page content.</p></div>",
